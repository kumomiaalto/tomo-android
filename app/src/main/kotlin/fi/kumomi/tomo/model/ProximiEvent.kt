...
data class ProximiEvent(val event_type: String, val geofence: ProximiioGeofence? = null, val beacon: ProximiioBLEDevice? = null, val location: ProximiLocation? = null, val dwellTime: Long? = null) {
    companion object {
