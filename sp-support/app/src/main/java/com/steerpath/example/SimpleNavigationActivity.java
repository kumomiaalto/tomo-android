...
public class SimpleNavigationActivity extends AppCompatActivity implements SteerpathMapFragment.MapViewListener {
    ...
    private void showRoutePreview(MetaFeature destination) {
        RoutePlan plan = new RoutePlan.Builder()
                ...
                // you may also start navigation with Location object instead of Feature
                //.destination(location)

                // change how much map will be zoomed out on review mode
                //.previewCameraPadding(250)
